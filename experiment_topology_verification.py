...
def run():
    ...
    results = {
        "lexical": {"wers": [], "accept_rates": [], "texts": []},
        "token_semantic": {"wers": [], "accept_rates": [], "texts": []},
        "graph_semantic": {"wers": [], "accept_rates": [], "texts": []}
    }
    ...
    for mode in ["lexical", "token_semantic", "graph_semantic"]:
        ...
        for idx in eval_samples:
            ...
            # Whisper output decoded text can be compared directly
    ...
    print(f"Span-Level Graph Verification      : {speedup_graph:.3f}x  (Speedup Gain: {speedup_graph - speedup_token:+.3f}x)")
    print("="*50)
